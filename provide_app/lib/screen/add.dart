...
import 'package:provide_app/database/validation.dart';
import 'package:provide_app/provider/helperclass.dart';
import 'package:provide_app/screen/home.dart';
import 'package:provide_app/widget/list.dart';
import 'package:provide_app/widget/textformfield.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<StudentProvider>(
      ...
      child: DropdownButtonFormField(
        ...
        items: CustomLists.course.map<DropdownMenuItem<String>>((String value) {
    ...
    Padding(
      ...
      child: DropdownButtonFormField<String>(
        ...
        items: CustomLists.sem.map<DropdownMenuItem<String>>((String value) {
          return DropdownMenuItem<String>(
            value: value,
            child: Text(value),
          );
